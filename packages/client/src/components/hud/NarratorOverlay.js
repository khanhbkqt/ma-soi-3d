...
function getPhaseNarration(from, to, round, playerCount, aliveCount) {
...
function getNightActionNarration(type, data) {
...
function getEventNarration(type, data) {
        ...
        children: [
          ...
          partialLine &&
            _jsxs('div', {
              ...
              children: [
                partialLine,
                _jsx('span', { className: 'narrator-cursor', children: '|' }),
              ],
            }),
        ],
      }),
