  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      {gameState.config.autoPlay ? (
        ...
        <button
          onClick={stepGame}
          className="bg-amber-600 hover:bg-amber-500 text-white px-3 py-1.5 rounded text-xs font-medium transition"
        >
          ⏭ Bước tiếp
        </button>
      )}
      ...
      {gameState.phase === Phase.GameOver && (
        <button
          ...
          className="bg-green-600 hover:bg-green-500 text-white px-3 py-1.5 rounded text-xs font-medium transition"
        >
          🔄 Ván Mới
        </button>
      )}
