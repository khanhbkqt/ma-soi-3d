    ...
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {!pvs.alive && (
                <span className="text-[10px] px-1 py-0.5 rounded bg-red-900/50 text-red-400">
                  ĐÃ CHẾT
                </span>
              )}
            </div>
      ...
      {pvs.deduction.deductionPrompt && (
        <div className="border-t border-gray-700/30">
          <div className="text-[10px] text-gray-500 font-medium px-3 py-1.5 bg-gray-900/30">
            🔍 PHÂN TÍCH ROLE
          </div>
...
function RoleContextSection({
  ...
  pvs: NonNullable<ReturnType<typeof useGameStore.getState>['playerViewState']>;
}) {
  ...
  return (
    <div className="border-t border-gray-700/30">
      ...
      <div className="px-3 py-1.5 space-y-1">
        ...
        {/* Lover */}
        {ctx.loverName && (
          <div className="text-[11px] text-pink-300">💕 Người yêu: {ctx.loverName}</div>
        )}
